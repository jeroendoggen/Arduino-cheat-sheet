...
\headerbox{ATmega328 Pinout}{name=pinout,column=2,below=random,bottomaligned=compound}{
  \begin{center}
...
\headerbox{Analog I/O}{name=analog,column=3,below=pins}{
  \begin{tabular}{l}
    ...
    \texttt{\textbf{analogWrite}(pin, value)}  \\
  \end{tabular}
}
...
\headerbox{Websites}{name=websites,column=3,below=serial}{
  \begin{tabular}{l}
...
\headerbox{Arduino Uno Board}{name=board,column=3,below=websites,bottomaligned=compound}{
  \begin{center}
